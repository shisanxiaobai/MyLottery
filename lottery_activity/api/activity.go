...
func (a *Activity) ActiveEdit(ctx context.Context, in *proto.EditRequest, out *proto.Response) error {
	...
	err := dao.ActiveEdit(data, int(in.Id))
	if err != nil {
		out.Code = 500
		out.Msg = "修改活动失败"
		return err
...
func (a *Activity) ActiveList(ctx context.Context, in *proto.ListRequest, out *proto.ListResponse) error {
	actives, count, err := dao.ActiveList(int(in.PageNum), int(in.PageSize))
	if err != nil {
		out.Code = 500
		out.Msg = "获取活动列表失败"
		return err
...
func (a *Activity) ActiveInfo(ctx context.Context, in *proto.IdRequest, out *proto.InfoResponse) error {
	active, err := dao.ActiveInfo(int(in.Id))
	if err != nil {
		out.Code = 500
		out.Msg = "获取活动信息失败"
		return err
	...
	prizes, err := dao.ActivePrizes(int(in.Id))
	if err != nil {
		out.Code = 500
		out.Msg = "获取活动奖品失败"
		return err
...
func (a *Activity) ActiveAddPrize(ctx context.Context, in *proto.PrizeAddRequest, out *proto.Response) error {
	err := dao.ActiveAddPrize(int(in.Id), in.Name)
	if err != nil {
		fmt.Println(err)
		out.Code = 500
		out.Msg = "增加活动奖品失败"
