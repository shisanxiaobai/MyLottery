<template>
  <el-card class="box-card">
    <el-form ref="activeForm" :model="activeInfo" :inline="true" label-position="top" :rules="activeInfoRules">
      <el-row>
        <el-col :span="7">
        ...
        <el-col :span="5">
          <el-form-item label="活动开始时间：">
            <el-date-picker v-model="activeInfo.startTime" type="datetime" format="yyyy-MM-dd HH:mm:ss"
        ...
        <el-col :span="5">
          <el-form-item label="活动结束时间：">
            <el-date-picker v-model="activeInfo.endTime" type="datetime" format="yyyy-MM-dd HH:mm:ss"
              placeholder="选择日期时间" value-format="timestamp">
            </el-date-picker>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="7">
          <el-form-item label="抽奖类型：">
            <el-select v-model="activeInfo.type" placeholder="请选择抽奖类型">
              <el-option v-for="item in [0, 1, 2, 3]" :key="item" :label="type[item]" :value="item"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
